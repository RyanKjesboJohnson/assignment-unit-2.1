...
let whomostPets 
if (mostPets === pets) {whomostPets = 'I have more pets then my friend'
  
}

else if (pets === friendsPets) {whomostPets = 'My friend and I have the same number of pets'}

else {whomostPets = 'My friend has more pets then me'};

console.log(whomostPets);
...
let result2
(adventurous) ? result2 = 'Adventures are great!' : result2 = 'How about we stay home?';
console.log(result2);
